...
namespace WristBand
{
    public class MyTrackerColliderEventCaster : ColliderEventCaster, IViveRoleComponent
    {
        [SerializeField]
        ...
        {
            buttonEventDataList.Add(new MyTrackerColliderButtonEventData(this, m_buttonTrigger, ColliderButtonEventData.InputButton.Trigger));
            buttonEventDataList.Add(new MyTrackerColliderButtonEventData(this, m_buttonPadOrStick, ColliderButtonEventData.InputButton.PadOrStick));
            buttonEventDataList.Add(new MyTrackerColliderButtonEventData(this, m_buttonFunctionKey, ColliderButtonEventData.InputButton.FunctionKey));
            buttonEventDataList.Add(new MyTrackerColliderButtonEventData(this, m_buttonGripOrHandTrigger, ColliderButtonEventData.InputButton.GripOrHandTrigger));
            ...
            for (ControllerButton btn = 0; addBtns > 0u; ++btn, addBtns >>= 1)
            {
                ...
                buttonEventDataList.Add(new MyTrackerColliderButtonEventData(this, btn, eventBtn++));
            }
