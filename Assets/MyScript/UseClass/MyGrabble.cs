...
namespace WristBand
{
    public class JiaoEventData : BaseEventData
    {
        ...
        public readonly MyAnimationCaster eventCaster;                           //jiao--data的Caster

        public IndexedSet<GameObject> callingHandlers = new IndexedSet<GameObject>();
        public JiaoEventData(MyAnimationCaster eventCaster)
            : base(null)
        {
        ...
        public bool GetWork()
        {
            return WristBandInput.bWork;
        }
    }

    public interface IWithAnimation
    {
        Vector3 movedPos {get;set;}
        void move();
        void reset();
    }
    public class MyGrabble : MonoBehaviour
    ...
    {
        [Serializable]
        public class UnityEventGrabbable : UnityEvent<MyGrabble> { }
